...
TEST_F(TestGenericSystem, generic_system_2dof_symetric_interfaces)
{
  ...
  ASSERT_EQ(1.57, j1p_s.get_value<double>());
  ASSERT_EQ(0.7854, j2p_s.get_value<double>());
  ASSERT_TRUE(std::isnan(j1p_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2p_c.get_value<double>()));
}
...
TEST_F(TestGenericSystem, generic_system_2dof_asymetric_interfaces)
{
  ...
  ASSERT_EQ(1.57, j1v_s.get_value<double>());
  ASSERT_EQ(0.7854, j2p_s.get_value<double>());
  ASSERT_TRUE(std::isnan(j1p_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2a_c.get_value<double>()));
}
  ...
  const double offset = 0)
{
  ...
  ASSERT_EQ(3.45, j1p_s.get_value<double>());
  ASSERT_EQ(0.0, j1v_s.get_value<double>());
  ASSERT_EQ(2.78, j2p_s.get_value<double>());
  ASSERT_EQ(0.0, j2v_s.get_value<double>());
  ASSERT_TRUE(std::isnan(j1p_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j1v_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2p_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2v_c.get_value<double>()));
  ...
  ASSERT_EQ(2.78, j2p_s.get_value<double>());
  ASSERT_EQ(0.0, j2v_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.22, j1v_c.get_value<double>());
  ASSERT_EQ(0.33, j2p_c.get_value<double>());
  ASSERT_EQ(0.44, j2v_c.get_value<double>());
  ...
  ASSERT_EQ(0.11 + offset, j1p_s.get_value<double>());
  ASSERT_EQ(0.22, j1v_s.get_value<double>());
  ASSERT_EQ(0.33 + offset, j2p_s.get_value<double>());
  ASSERT_EQ(0.44, j2v_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.22, j1v_c.get_value<double>());
  ASSERT_EQ(0.33, j2p_c.get_value<double>());
  ASSERT_EQ(0.44, j2v_c.get_value<double>());
  ...
  ASSERT_EQ(0.33 + offset, j2p_s.get_value<double>());
  ASSERT_EQ(0.44, j2v_s.get_value<double>());
  ASSERT_EQ(0.55, j1p_c.get_value<double>());
  ASSERT_EQ(0.66, j1v_c.get_value<double>());
  ASSERT_EQ(0.77, j2p_c.get_value<double>());
  ASSERT_EQ(0.88, j2v_c.get_value<double>());
  ...
  const std::string & urdf, const std::string component_prefix, bool validate_same_group)
{
  ...
  ASSERT_TRUE(rm.read(TIME, PERIOD).ok);
  ASSERT_EQ(0.11, j1p_s.get_value<double>());
  ASSERT_EQ(0.22, j1v_s.get_value<double>());
  ASSERT_EQ(0.33, j2p_s.get_value<double>());
  ASSERT_EQ(0.44, j2v_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.22, j1v_c.get_value<double>());
  ASSERT_EQ(0.33, j2p_c.get_value<double>());
...
TEST_F(TestGenericSystem, generic_system_2dof_other_interfaces)
{
  ...
  ASSERT_EQ(1.55, j1p_s.get_value<double>());
  ASSERT_EQ(0.1, j1v_s.get_value<double>());
  ASSERT_EQ(0.65, j2p_s.get_value<double>());
  ASSERT_EQ(0.2, j2v_s.get_value<double>());
  ASSERT_EQ(0.5, vo_s.get_value<double>());
  ASSERT_TRUE(std::isnan(j1p_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2p_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(vo_c.get_value<double>()));
  ...
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.33, j2p_c.get_value<double>());
  ASSERT_EQ(0.99, vo_c.get_value<double>());
  ...
  ASSERT_EQ(0.1, j1v_s.get_value<double>());
  ASSERT_EQ(0.33, j2p_s.get_value<double>());
  ASSERT_EQ(0.99, vo_s.get_value<double>());
  ASSERT_EQ(0.2, j2v_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.33, j2p_c.get_value<double>());
  ASSERT_EQ(0.99, vo_c.get_value<double>());
...
TEST_F(TestGenericSystem, generic_system_2dof_sensor)
{
  ...
  ASSERT_EQ(0.0, j1p_s.get_value<double>());
  ASSERT_EQ(0.0, j1v_s.get_value<double>());
  ASSERT_EQ(0.0, j2p_s.get_value<double>());
  ASSERT_EQ(0.0, j2v_s.get_value<double>());
  EXPECT_TRUE(std::isnan(sfx_s.get_value<double>()));
  EXPECT_TRUE(std::isnan(sfy_s.get_value<double>()));
  EXPECT_TRUE(std::isnan(stx_s.get_value<double>()));
  EXPECT_TRUE(std::isnan(sty_s.get_value<double>()));
  ASSERT_TRUE(std::isnan(j1p_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2p_c.get_value<double>()));
  ...
  std::string & urdf, const std::string & component_name)
{
  ...
  ASSERT_TRUE(std::isnan(j1p_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2p_c.get_value<double>()));
  EXPECT_TRUE(std::isnan(sfx_c.get_value<double>()));
  EXPECT_TRUE(std::isnan(sfy_c.get_value<double>()));
  EXPECT_TRUE(std::isnan(stx_c.get_value<double>()));
  EXPECT_TRUE(std::isnan(sty_c.get_value<double>()));
  ...
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.33, j2p_c.get_value<double>());
  ASSERT_EQ(1.11, sfx_c.get_value<double>());
  ASSERT_EQ(2.22, sfy_c.get_value<double>());
  ASSERT_EQ(3.33, stx_c.get_value<double>());
  ASSERT_EQ(4.44, sty_c.get_value<double>());
  ...
  ASSERT_EQ(0.33, j2p_s.get_value<double>());
  ASSERT_EQ(0.0, j2v_s.get_value<double>());
  ASSERT_EQ(1.11, sfx_s.get_value<double>());
  ASSERT_EQ(2.22, sfy_s.get_value<double>());
  ASSERT_EQ(3.33, stx_s.get_value<double>());
  ASSERT_EQ(4.44, sty_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.33, j2p_c.get_value<double>());
  ASSERT_EQ(1.11, sfx_c.get_value<double>());
  ASSERT_EQ(2.22, sfy_c.get_value<double>());
  ...
  std::string & urdf, const std::string & component_name)
{
  ...
  ASSERT_EQ(0.0, j2v_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.05, j1v_c.get_value<double>());
  ...
  rm.read(TIME, PERIOD);
  ASSERT_EQ(0.11, j1p_s.get_value<double>());
  ASSERT_EQ(0.05, j1v_s.get_value<double>());
  ASSERT_EQ(-0.22, j2p_s.get_value<double>());
  ASSERT_EQ(-0.1, j2v_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.05, j1v_c.get_value<double>());
}
...
TEST_F(TestGenericSystem, generic_system_2dof_functionality_with_offset_custom_interface)
{
  ...
  rm.read(TIME, PERIOD);
  ASSERT_EQ(0.11, j1p_s.get_value<double>());
  ASSERT_EQ(0.11 + offset, c_j1p_s.get_value<double>());
  ASSERT_EQ(0.22, j1v_s.get_value<double>());
  ASSERT_EQ(0.33, j2p_s.get_value<double>());
  ASSERT_EQ(0.33 + offset, c_j2p_s.get_value<double>());
  ASSERT_EQ(0.44, j2v_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.22, j1v_c.get_value<double>());
  ASSERT_EQ(0.33, j2p_c.get_value<double>());
...
TEST_F(TestGenericSystem, valid_urdf_ros2_control_system_robot_with_gpio)
{
  ...
  // State interfaces without initial value are set to 0
  ASSERT_TRUE(std::isnan(gpio1_a_o1_s.get_value<double>()));
  ASSERT_TRUE(std::isnan(gpio2_vac_s.get_value<double>()));
  ASSERT_TRUE(std::isnan(gpio1_a_o1_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(gpio2_vac_c.get_value<double>()));
  ...
  ASSERT_TRUE(std::isnan(gpio1_a_o1_s.get_value<double>()));
  ASSERT_TRUE(std::isnan(gpio2_vac_s.get_value<double>()));
  ASSERT_EQ(0.111, gpio1_a_o1_c.get_value<double>());
  ASSERT_EQ(0.222, gpio2_vac_c.get_value<double>());
  ...
  // read() mirrors commands + offset to states
  rm.read(TIME, PERIOD);
  ASSERT_EQ(0.111, gpio1_a_o1_s.get_value<double>());
  ASSERT_EQ(0.222, gpio2_vac_s.get_value<double>());
  ASSERT_EQ(0.111, gpio1_a_o1_c.get_value<double>());
  ASSERT_EQ(0.222, gpio2_vac_c.get_value<double>());
  ...
  ASSERT_EQ(0.111, gpio1_a_o1_s.get_value<double>());
  ASSERT_EQ(0.222, gpio2_vac_s.get_value<double>());
  ASSERT_EQ(0.333, gpio1_a_o1_c.get_value<double>());
  ASSERT_EQ(0.444, gpio2_vac_c.get_value<double>());
  ...
  std::string & urdf, const std::string & component_name)
{
  ...
  EXPECT_TRUE(std::isnan(gpio1_a_o1_s.get_value<double>()));
  EXPECT_TRUE(std::isnan(gpio1_a_i1_s.get_value<double>()));
  EXPECT_TRUE(std::isnan(gpio1_a_o2_s.get_value<double>()));
  EXPECT_TRUE(std::isnan(gpio2_vac_s.get_value<double>()));
  EXPECT_TRUE(std::isnan(gpio1_a_o1_c.get_value<double>()));
  EXPECT_TRUE(std::isnan(gpio1_a_i1_c.get_value<double>()));
  EXPECT_TRUE(std::isnan(gpio1_a_i2_c.get_value<double>()));
  EXPECT_TRUE(std::isnan(gpio2_vac_c.get_value<double>()));
  ...
  EXPECT_TRUE(std::isnan(gpio1_a_o2_s.get_value<double>()));
  EXPECT_TRUE(std::isnan(gpio2_vac_s.get_value<double>()));
  ASSERT_EQ(0.11, gpio1_a_o1_c.get_value<double>());
  ASSERT_EQ(0.33, gpio1_a_i1_c.get_value<double>());
  ASSERT_EQ(1.11, gpio1_a_i2_c.get_value<double>());
  ASSERT_EQ(2.22, gpio2_vac_c.get_value<double>());
  ...
  // read() mirrors commands to states
  rm.read(TIME, PERIOD);
  ASSERT_EQ(0.11, gpio1_a_o1_s.get_value<double>());
  ASSERT_EQ(0.33, gpio1_a_i1_s.get_value<double>());
  ASSERT_EQ(1.11, gpio1_a_o2_s.get_value<double>());
  ASSERT_EQ(2.22, gpio2_vac_s.get_value<double>());
  ASSERT_EQ(0.11, gpio1_a_o1_c.get_value<double>());
  ASSERT_EQ(0.33, gpio1_a_i1_c.get_value<double>());
  ASSERT_EQ(1.11, gpio1_a_i2_c.get_value<double>());
  ASSERT_EQ(2.22, gpio2_vac_c.get_value<double>());
...
TEST_F(TestGenericSystem, sensor_with_initial_value)
{
  ...
  ASSERT_EQ(0.0, force_x_s.get_value<double>());
  ASSERT_EQ(0.0, force_y_s.get_value<double>());
  ASSERT_EQ(0.0, force_z_s.get_value<double>());
}
...
TEST_F(TestGenericSystem, gpio_with_initial_value)
{
  ...
  ASSERT_EQ(1, state.get_value<double>());
}
...
TEST_F(TestGenericSystem, simple_dynamics_pos_vel_acc_control_modes_interfaces)
{
  ...
  EXPECT_EQ(3.45, j1p_s.get_value<double>());
  EXPECT_EQ(0.0, j1v_s.get_value<double>());
  EXPECT_EQ(0.0, j1a_s.get_value<double>());
  EXPECT_EQ(2.78, j2p_s.get_value<double>());
  EXPECT_EQ(0.0, j2v_s.get_value<double>());
  EXPECT_EQ(0.0, j2a_s.get_value<double>());
  ASSERT_TRUE(std::isnan(j1p_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j1v_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2v_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2a_c.get_value<double>()));
  ...
  ASSERT_TRUE(std::isnan(j1v_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2v_c.get_value<double>()));
  ASSERT_EQ(3.5, j2a_c.get_value<double>());
  ...
  rm.read(TIME, PERIOD);
  EXPECT_EQ(0.11, j1p_s.get_value<double>());
  EXPECT_EQ(-33.4, j1v_s.get_value<double>());
  EXPECT_NEAR(-334.0, j1a_s.get_value<double>(), COMPARE_DELTA);
  EXPECT_EQ(2.78, j2p_s.get_value<double>());
  EXPECT_EQ(0.0, j2v_s.get_value<double>());
  EXPECT_EQ(3.5, j2a_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_TRUE(std::isnan(j1v_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2v_c.get_value<double>()));
  ASSERT_EQ(3.5, j2a_c.get_value<double>());
  ...
  EXPECT_NEAR(334.0, j1a_s.get_value<double>(), COMPARE_DELTA);
  EXPECT_EQ(2.78, j2p_s.get_value<double>());
  EXPECT_NEAR(0.35, j2v_s.get_value<double>(), COMPARE_DELTA);
  EXPECT_EQ(3.5, j2a_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_TRUE(std::isnan(j1v_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2v_c.get_value<double>()));
  ...
  EXPECT_EQ(0.0, j1v_s.get_value<double>());
  EXPECT_EQ(0.0, j1a_s.get_value<double>());
  EXPECT_EQ(2.815, j2p_s.get_value<double>());
  EXPECT_NEAR(0.7, j2v_s.get_value<double>(), COMPARE_DELTA);
  EXPECT_EQ(3.5, j2a_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_TRUE(std::isnan(j1v_c.get_value<double>()));
  ASSERT_TRUE(std::isnan(j2v_c.get_value<double>()));
  ...
  EXPECT_EQ(3.5, j2a_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.5, j1v_c.get_value<double>());
  ASSERT_EQ(2.0, j2v_c.get_value<double>());
  ASSERT_EQ(3.5, j2a_c.get_value<double>());
  ...
  rm.read(TIME, PERIOD);
  EXPECT_EQ(0.11, j1p_s.get_value<double>());
  EXPECT_EQ(0.5, j1v_s.get_value<double>());
  EXPECT_EQ(5.0, j1a_s.get_value<double>());
  EXPECT_EQ(2.885, j2p_s.get_value<double>());
  EXPECT_EQ(2.0, j2v_s.get_value<double>());
  EXPECT_NEAR(13.0, j2a_s.get_value<double>(), COMPARE_DELTA);
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.5, j1v_c.get_value<double>());
  ASSERT_EQ(2.0, j2v_c.get_value<double>());
  ASSERT_EQ(3.5, j2a_c.get_value<double>());
  ...
  // read() mirrors commands to states and calculate dynamics (both velocity mode)
  rm.read(TIME, PERIOD);
  EXPECT_EQ(0.16, j1p_s.get_value<double>());
  EXPECT_EQ(0.5, j1v_s.get_value<double>());
  EXPECT_EQ(0.0, j1a_s.get_value<double>());
  EXPECT_EQ(3.085, j2p_s.get_value<double>());
  EXPECT_EQ(2.0, j2v_s.get_value<double>());
  EXPECT_EQ(0.0, j2a_s.get_value<double>());
  ASSERT_EQ(0.11, j1p_c.get_value<double>());
  ASSERT_EQ(0.5, j1v_c.get_value<double>());
